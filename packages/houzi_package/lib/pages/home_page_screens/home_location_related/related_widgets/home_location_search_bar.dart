...
class HomeLocationSearchBarWidgetState
  ...
  //               color:
  //                   AppThemePreferences().appTheme.homeScreenSearchBarIconColor,
  //             ),
  //           ),
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: SvgPicture.asset(
          AppThemePreferences.homeFilterImagePath,
