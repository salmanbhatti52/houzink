  ...
  Widget preferencesWidget(){
    return GenericSettingsWidget(
      ...
      body: Column(
        ...
        children: [
          NewGenericWidgetRow(
            icon: AppThemePreferences.darkModeImagePath,
          ...
          // ),
          NewGenericWidgetRow(
            icon: AppThemePreferences.translateImagePath,
            icon2: AppThemePreferences.rightArrowImagePath,
  ...
  Widget communityStandardsAndLegalPoliciesWidget(){
    return GenericSettingsWidget(
      ...
      body: Column(
        ...
        children: [
          NewGenericWidgetRow(
            icon: AppThemePreferences.termsImagePath,
            icon2: AppThemePreferences.rightArrowImagePath,
          ...
          // ),
          NewGenericWidgetRow(
            icon: AppThemePreferences.privacyImagePath,
            icon2: AppThemePreferences.rightArrowImagePath,
