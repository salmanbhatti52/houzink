          ...
          return SafeArea(
            child: Wrap(
              children: [
                ...
                if (actionButtonMap["_author"] == userId && article.propertyInfo!.privateNote != null && article.propertyInfo!.privateNote!.isNotEmpty)
                  genericOptionsOfBottomSheet(
                    actionButtonMap["_propertyId"],
                    UtilityMethods.getLocalizedString("Private Note"),
                    propertyListIndex: actionButtonMap["index"],
                    article: actionButtonMap["item"],
                    onPressed: (a, b) {
                      Article article = actionButtonMap["item"];
