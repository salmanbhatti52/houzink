                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          UtilityMethods.getLocalizedString("Login"),
            ...
            if (response.statusCode != 200) {
              if (response.statusCode == 403 && response.data is Map) {
                ...
                if (map != null &&
                    ...
                    map["reason"] != null) {
                  _showToast(
                      context, UtilityMethods.cleanContent(map["reason"]));
                  return;
                }
                if (map != null &&
                    ...
                    map["message"] != null) {
                  _showToast(
                      context, UtilityMethods.cleanContent(map["message"]));
                  return;
                }
                if (map != null &&
              ...
              Provider.of<UserLoggedProvider>(context, listen: false)
                  .loggedIn();
              ...
              _showToast(context,
                  UtilityMethods.cleanContent(response.data["message"]));
            }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GenericLinkWidget(
        ...
        linkText: UtilityMethods.getLocalizedString("forgot_password_reset"),
        onLinkPressed: () {
