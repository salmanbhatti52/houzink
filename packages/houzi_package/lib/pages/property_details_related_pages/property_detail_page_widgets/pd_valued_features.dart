...
class _PropertyDetailPageValuedFeaturedState
  ...
  Widget valuedFeaturesWidget() {
    return _mapOfFeaturesWithValues == null || _mapOfFeaturesWithValues.isEmpty
        ? Container()
        : Container(
            height: 50,
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return singleValueFeatureWidget(
                    index, key, value!, label, _iconMap, widget.article);
              },
            ),
          );
  }

  Widget singleValueFeatureWidget(int index, String key, String value,
      String label, Map<String, dynamic> _iconMap, Article _article) {
    return Padding(
