...
class _PropertyProfileBottomButtonActionBarState
                  ...
                  : Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (showEmailActionButton() && showCallActionButton())
                            const SizedBox(width: 5),
                          if (showCallActionButton())
                            Expanded(
                              flex: 1,
  ...
  Widget emailElevatedButtonWidget() {
    return HooksConfigurations.widgetItem(
            context, widget.article, "email_button") ??
        ButtonWidget(
  ...
  Widget callElevatedButtonWidget() {
    return HooksConfigurations.widgetItem(
            context, widget.article, "call_button") ??
        ButtonWidget(
  ...
  Widget whatsappElevatedButtonWidget() {
    return HooksConfigurations.widgetItem(
            context, widget.article, "whatsapp_button") ??
        ButtonWidget(
