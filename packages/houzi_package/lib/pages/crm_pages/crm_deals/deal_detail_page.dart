                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            CRMIconAndText(AppThemePreferences.groupsImagePath, widget.deal.agentName),
                            CRMIconAndText(AppThemePreferences.priceTagImagePath, widget.deal.dealValue),
                          ],
                        ),
                        const CRMDetailGap(gap: 20),
                        CRMIconAndText(AppThemePreferences.statusImagePath, "status",addBottomPadding: true),
                        dropDownWidget(
                          "status", statusOptionsList, _statusValue, DEAL_SET_STATUS,
                        ),
                        const CRMDetailGap(gap: 20),
                        CRMIconAndText(AppThemePreferences.timerImagePath, "action_due_date",addBottomPadding: true),
                        datePickerWidget(DEAL_SET_ACTION_DUE_DATE),
                        const CRMDetailGap(gap: 20),
                        CRMIconAndText(AppThemePreferences.filterImagePath, "next_action",addBottomPadding: true),
                        dropDownWidget(
                          "next_action", nextActionOptionsList, _nextActionValue, DEAL_SET_NEXT_ACTION,
                        ),
                        const CRMDetailGap(gap: 20),
                        CRMIconAndText(AppThemePreferences.calendarMonthImagePath, "last_contact_date",addBottomPadding: true),
