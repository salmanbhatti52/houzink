...
class AppThemePreferences{
  ...
  static String addPropertyButtonImagePath = "assets/icon/add-property-button-icon.svg";
  ///
  /// New Right Arrow Icon Image Path:
  static String rightArrowImagePath = "assets/icon/profile-arrow-right-icon.svg";
  ///
  ...
  static String addPropertiesImagePath = "assets/icon/profile-add-properties-icon.svg";
  ///
  ...
  static String requestDemoImagePath = "assets/icon/profile-request-demo-icon.svg";
  ///
  ...
  static String changePasswordImagePath = "assets/icon/change-password-icon.svg";
  ///
  ...
  static String pdSmallLocationImagePath = "assets/icon/pd-small-location-icon.svg";
  ///
  ...
  static String pdSmallBathtubImagePath = "assets/icon/pd-small-bathtub-icon.svg";
  ///
  /// New PD Small Area Size Icon Image Path:
  static String pdSmallAreaSizeImagePath = "assets/icon/pd-small-area-size-icon.svg";
  ///
...
class AppTheme{
  ...
  AppTheme({this.isDark = false}) {
    ...
    _primaryColor = Color(0xFF25ADDE);
