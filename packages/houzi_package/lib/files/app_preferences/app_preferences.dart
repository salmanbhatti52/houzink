...
class AppThemePreferences {
  ...
  static FontWeight labelFontWeight = FontWeight.w400;
  ...
  static Color appPrimaryColor = const Color(0xFF25ADDE);

  ///
  /// Secondary Color of App:
  static Color appSecondaryColor = const Color(0xFF25ADDE);
  ...
  ///
  /// Master Color of App Icons:
  static Color appIconsMasterColorDark = const Color(0xFF868a8d);
  ...
  static Color searchBarBackgroundColorDark = const Color(0xFF3a3b3d);
  ...
  ///
  /// Bottom Tab Bar Tint Color
  static Color unSelectedBottomNavBarTintColor = const Color(0xFF737373);

  ///
  /// App bottom bar background color
  static Color bottomNavBarBackgroundColorLight = const Color(0xFFFAFAFA);
  ...
  static Color? filterPageTempTextPlaceHolderTextColorLight =
      normalTextColorLight;
  static Color? crmTypeHeadingTextColorLight = const Color(0xFF898993);
  static Color? crmHeadingTextColorLight = const Color(0xFF46455D);
  static Color? crmNormalTextColorLight = const Color(0xFF44445C);
  static Color? crmSubNormalTextColorLight = const Color(0xFF898993);
  static Color? crmIconColorLight = const Color(0xFFB8B8C1);
  ...
  static Color facebookSignInButtonColorLight = const Color(0xFF1877f2);
  ...
  static Color titleTextColorDark = const Color(0xFFe1e2e6);
  // static Color titleTextColorDark = Colors.grey[300];
  static Color bodyTextColorDark = const Color(0xFFcfd0d4);
  ...
  static Color searchBarTextColorDark = const Color(0xFFb2b3b6);
  ...
  ///
  /// HomeScreen Status Bar color
  static Color homeScreenStatusBarColorDark = const Color(0XFF242527);
  // static Color homeScreenStatusBarColorDark =  Colors.white10;
  ///
  /// SliverAppBar Background color
  static Color sliverAppBarBackgroundColorDark = const Color(0XFF242527);
  ...
  ///
  /// Divider color
  static Color dividerColorDark = const Color(0x1FFFFFFF);

  ///
  /// Card color
  static Color cardColorDark = const Color(0XFF242527);
  ...
  static Color searchBarIconColorDark = const Color(0xFF626365);
  ...
  static Color containerBackgroundColorDark =
      const Color(0xFF3a3b3d); //Colors.white10;
  ///
  /// Property Details Page Chips Background color
  ...
  ///
  /// Facebook Sign-In Button Background color
  static Color facebookSignInButtonColorDark = const Color(0xFF0a3061);
  ...
  ///
  /// App bottom bar background color
  static Color bottomNavBarBackgroundColorDark = const Color(0xFF303030);
  ...
  ///
  /// New Logo Small Icon Image Path:
  static String logoSmallIconImagePath = "assets/icon/logo-small-icon.png";

  ///
  /// New Logo Icon Image Path:
  static String logoIconImagePath = "assets/icon/logo-icon.png";

  ///
  /// New Back Icon Image Path:
  static String backIconImagePath = "assets/icon/back-icon.svg";

  ///
  /// New Drawer Menu Image Path:
  static String drawerMenuImagePath = "assets/icon/drawer-menu-icon.svg";

  ///
  /// New Search History Image Path:
  static String searchHistoryImagePath = "assets/icon/search-history-icon.svg";

  ///
  /// New Home Filter Image Path:
  static String homeFilterImagePath = "assets/icon/home-filter-icon.svg";

  ///
  /// New Add Property Button Icon Image Path:
  static String addPropertyButtonImagePath =
      "assets/icon/add-property-button-icon.svg";

  ///
  /// New Right Arrow Icon Image Path:
  static String rightArrowImagePath =
      "assets/icon/profile-arrow-right-icon.svg";

  ///
  /// New Person Icon Image Path:
  static String personImagePath = "assets/icon/profile-person-icon.svg";

  ///
  /// New Properties Icon Image Path:
  static String propertiesImagePath = "assets/icon/profile-properties-icon.svg";

  ///
  /// New Add Properties Icon Image Path:
  static String addPropertiesImagePath =
      "assets/icon/profile-add-properties-icon.svg";

  ///
  /// New Membership Icon Image Path:
  static String membershipImagePath = "assets/icon/profile-membership-icon.svg";

  ///
  /// New Setting Icon Image Path:
  static String settingImagePath = "assets/icon/profile-setting-icon.svg";

  ///
  /// New All User Icon Image Path:
  static String allUserImagePath = "assets/icon/profile-all-users-icon.svg";

  ///
  /// New Request Demo Icon Image Path:
  static String requestDemoImagePath =
      "assets/icon/profile-request-demo-icon.svg";

  ///
  /// New Log In Icon Image Path:
  static String logInImagePath = "assets/icon/profile-login-icon.svg";

  ///
  /// New Log Out Icon Image Path:
  static String logOutImagePath = "assets/icon/logout-icon.svg";

  ///
  /// New Upload Icon Image Path:
  static String uploadImagePath = "assets/icon/upload-icon.svg";

  ///
  /// New Edit Profile Icon Image Path:
  static String editProfileImagePath = "assets/icon/edit-profile-icon.svg";

  ///
  /// New Change Password Icon Image Path:
  static String changePasswordImagePath =
      "assets/icon/change-password-icon.svg";

  ///
  /// New Dark Mode Icon Image Path:
  static String darkModeImagePath = "assets/icon/dark-mode-icon.svg";

  ///
  /// New Translate Icon Image Path:
  static String translateImagePath = "assets/icon/translate-icon.svg";

  ///
  /// New Terms Icon Image Path:
  static String termsImagePath = "assets/icon/terms-icon.svg";

  ///
  /// New Privacy Icon Image Path:
  static String privacyImagePath = "assets/icon/privacy-icon.svg";
  ...
  static String drawerQuickAddPropertiesImagePath =
      "assets/icon/drawer-quick-add-properties-icon.svg";
  ...
  static String drawerAgenciesImagePath =
      "assets/icon/drawer-agencies-icon.svg";

  ///
  /// New Drawer Real Estate Agent Icon Image Path:
  static String drawerRealEstateAgentImagePath =
      "assets/icon/drawer-real-estate-agent-icon.svg";

  ///
  /// New Drawer Request Properties Icon Image Path:
  static String drawerRequestPropertiesImagePath =
      "assets/icon/drawer-request-properties-icon.svg";

  ///
  /// New Drawer Favorite Icon Image Path:
  static String drawerFavoriteImagePath =
      "assets/icon/drawer-favorite-icon.svg";

  ///
  /// New Drawer Saved Searches Icon Image Path:
  static String drawerSavedSearchesImagePath =
      "assets/icon/drawer-saved-searches-icon.svg";

  ///
  /// New Drawer Dashboard Icon Image Path:
  static String drawerDashboardImagePath =
      "assets/icon/drawer-dashboard-icon.svg";

  ///
  /// New Drawer Activities Icon Image Path:
  static String drawerActivitiesImagePath =
      "assets/icon/drawer-activities-icon.svg";

  ///
  /// New Drawer Inquiries Icon Image Path:
  static String drawerInquiriesImagePath =
      "assets/icon/drawer-inquiries-icon.svg";
  ...
  ///
  /// New Drawer Contact Icon Image Path:
  static String drawerContactImagePath = "assets/icon/drawer-contact-icon.svg";

  ///
  /// New PD Location Icon Image Path:
  static String pdLocationImagePath = "assets/icon/pd-location-icon.svg";

  ///
  /// New PD Small Location Icon Image Path:
  static String pdSmallLocationImagePath =
      "assets/icon/pd-small-location-icon.svg";

  ///
  /// New PD Small Bed Icon Image Path:
  static String pdSmallBedImagePath = "assets/icon/pd-small-bed-icon.svg";

  ///
  /// New PD Small Bathtub Icon Image Path:
  static String pdSmallBathtubImagePath =
      "assets/icon/pd-small-bathtub-icon.svg";

  ///
  /// New PD Small Area Size Icon Image Path:
  static String pdSmallAreaSizeImagePath =
      "assets/icon/pd-small-area-size-icon.svg";
  ...
  static InputDecoration formFieldDecoration({
    ...
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
            color:
                enabledBorderColor ?? const Color.fromARGB(255, 216, 210, 210)),
      ),
...
class AppTheme {
  ...
  AppTheme({this.isDark = false}) {
    ...
    _primaryColor = const Color(0xFF25ADDE);
