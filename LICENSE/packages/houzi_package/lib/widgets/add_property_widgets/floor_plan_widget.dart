...
class GenericFloorPlanWidget extends StatefulWidget{
  ...
  final GenericFloorPlanWidgetListener genericFloorPlanWidgetListener;
  ...
  @override
  State<StatefulWidget> createState() => GenericFloorPlanWidgetState();

}

class GenericFloorPlanWidgetState extends State<GenericFloorPlanWidget> {
  ...
  @override
  void dispose() {
    if(_planTitleTextController != null )_planTitleTextController.dispose();
    if(_planBedroomsTextController != null )_planBedroomsTextController.dispose();
    if(_planBathroomsTextController != null )_planBathroomsTextController.dispose();
    if(_planPriceTextController != null )_planPriceTextController.dispose();
    if(_planPricePostFixTextController != null )_planPricePostFixTextController.dispose();
    if(_planSizeTextController != null )_planSizeTextController.dispose();
    if(_planDescriptionTextController != null )_planDescriptionTextController.dispose();
    super.dispose();
  }
