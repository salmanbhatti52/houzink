                          ...
                          Container(
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index){
                                ...
                                return SizedBox(
                                  height: _articleBoxDesign.getArticleBoxDesignHeight(design: widget.itemDesignNotifier.homeScreenItemDesign),
                                  child: _articleBoxDesign.getArticleBoxDesign(
                                    design: widget.itemDesignNotifier.homeScreenItemDesign,
                                    buildContext: context,
                                    heroId: heroId,
                                    article: item,
                                    onTap: () => widget.onPropArticleTap(item, propId, heroId),
