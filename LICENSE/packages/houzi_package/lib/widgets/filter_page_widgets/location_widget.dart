...
class LocationWidgetState extends State<LocationWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GenericLocationWidget(
      ...
      onCitySelectionTap: () {
        widget.pickerType == dropDownTermPicker
      ...
      listener: ({latitude, longitude, selectedLocation, selectedRadius, selectedTabIndex, selectedTermSlugs, selectedTerms}) {
        if(mounted) setState(() {
          ...
          if(selectedRadius != null){
            _selectedRadiusKm = selectedRadius.toString();
    ...
    return Container(
      ...
      child: SHOW_SEARCH_BY_CITY && SHOW_SEARCH_BY_LOCATION
          ? TabBarWidget(
              ...
              selectedRadiusKm: widget.selectedRadiusKm,
        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                GenericTextWidget(
                  "Radius ${double.parse(selectedRadiusKm).round()} km",
                ...
                Container(
                  ...
                  child: SliderTheme(
                    ...
                    child: Slider(
                      value: double.parse(selectedRadiusKm),
                      max: 100,
                      min: 1,
                      label: null,
                      onChanged: listener,
