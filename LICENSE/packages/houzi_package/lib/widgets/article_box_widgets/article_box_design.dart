...
class ArticleBoxDesign{
  PropertyItemHook propertyItemHook = UtilityMethods.propertyItem;
  ...
  Widget getArticleBoxDesign(
    ...
    String _areaPostFix = article.features!.landAreaUnit == "" ? MEASUREMENT_UNIT_TEXT : article.features!.landAreaUnit!;
    ...
    String _propertyType = article.propertyInfo!.propertyType!.toUpperCase();
    ...
    Map<String, dynamic> _informationDataMap = {
      ...
      AB_PROPERTY_TYPE : _propertyType,
    };
