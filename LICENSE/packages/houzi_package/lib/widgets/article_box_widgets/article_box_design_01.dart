...
Widget propertyTagsWidget({
  ...
  return isFeatured == false && (_propertyStatus == null || _propertyStatus.isEmpty) ? Container() : Container(
    ...
    child: Row(
      ...
      children: [
        ...
        _propertyStatus == null || _propertyStatus.isEmpty ? Container() : Container(
          padding: EdgeInsets.symmetric(horizontal: isFeatured ? 5:0),
          alignment: Alignment.topRight,
          child: TagWidget(label: _propertyStatus),
        ),
      ],
    ),
  );
