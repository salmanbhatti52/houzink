                ...
                Column(
                  ...
                  children: propertyDetailPageConfigList.map((map) {
                    return PropertyDetailsPageWidgets(
                      ...
                      widgetsHook: UtilityMethods.widgetItem,
                ...
                Expanded(
                  ...
                  child: CircleAvatar(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Share.share(UtilityMethods.getLocalizedString("property_share_msg",inputWords: ["${UtilityMethods.stripHtmlIfNeeded(_article!.title!)}.",_article!.link!.isEmpty?_articleLink:_article!.link]));
                      },
                    ),
                  ),
                ),
