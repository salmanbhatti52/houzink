...
class _FilterPageWidgetsState extends State<FilterPageWidgets> {
    ...
    generalNotifierLister = () {
      ...
      if(isSectionTypePropertyLocation() || isWidgetTypeTermPropertyCity()) {
        ...
        if(GeneralNotifier().change == GeneralNotifier.FILTER_DATA_LOADING_COMPLETE){
          _dataInitializationMap = HiveStorageManager.readFilterDataInfo();
          loadData();
          if(mounted) setState(() {});
        }
      }
  ...
  bool isSectionTypeStringPicker() {
