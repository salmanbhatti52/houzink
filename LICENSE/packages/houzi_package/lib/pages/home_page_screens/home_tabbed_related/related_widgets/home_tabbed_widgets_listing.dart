          ...
          return noDataReceived
            ...
            children: [
              if(homeConfigMap[sectionTypeKey] == recentSearchKey)
                homeScreenList.isEmpty ? NoResultErrorWidget(
                  headerErrorText: UtilityMethods.getLocalizedString("no_result_found"),
                  bodyErrorText: UtilityMethods.getLocalizedString("no_recent_properties_error_message"),
                  hideGoBackButton: true,
                      ...
                      listingView: homeConfigMap[sectionListingViewKey] ?? homeScreenWidgetsListingListView,
                    ),
