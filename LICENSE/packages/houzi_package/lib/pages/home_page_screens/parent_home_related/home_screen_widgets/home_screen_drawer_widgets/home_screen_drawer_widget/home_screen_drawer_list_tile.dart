  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        ...
        //     ? AppThemePreferences().appTheme.primaryColor.withOpacity(0.1)
        //     : null,
        selected: widget.sectionType == widget.selectedHome || widget.sectionType == homeSectionType ? true : false,
        selectedTileColor: widget.sectionType == widget.selectedHome || widget.sectionType == homeSectionType
            ? AppThemePreferences().appTheme.primaryColor!.withOpacity(0.1)
            : null,
        ...
        title: GenericTextWidget(
          ...
          style: TextStyle(
              ...
              //     ? AppThemePreferences().appTheme.primaryColor
              //     : AppThemePreferences().appTheme.normalTextColor),
              color: widget.sectionType == widget.selectedHome || widget.sectionType == homeSectionType
                  ? AppThemePreferences().appTheme.primaryColor
                  : AppThemePreferences().appTheme.normalTextColor),
        ),
        leading: Icon(widget.iconData,
            ...
            //     : AppThemePreferences().appTheme.normalTextColor),
            color:
            widget.sectionType == widget.selectedHome || widget.sectionType == homeSectionType
                ? AppThemePreferences().appTheme.primaryColor
                : AppThemePreferences().appTheme.normalTextColor),

        onTap: widget.fromHook ?? false
            ? () {
          onTapFromHook(context, widget.checkLogin ?? false, widget.onTap, widget.isUserLoggedIn ?? false);
        }
