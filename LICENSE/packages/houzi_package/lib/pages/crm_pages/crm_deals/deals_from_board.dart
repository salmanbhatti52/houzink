...
class _DealsFromBoardState extends State<DealsFromBoard> with TickerProviderStateMixin {
  ...
  Widget dealDetailWidget(CRMDealsAndLeads deal) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CRMIconAndText(
        ...
        Row(
          ...
          children: [
            if (deal.email != null && deal.email!.isNotEmpty)
              GestureDetector(
                onTap: () {
                  launch("mailto:${deal.email}");
                },
                child: CRMIconAndText(
                  AppThemePreferences.emailFilledIcon,
                  deal.email,
                ),
              ),
            if (deal.mobile != null && deal.mobile!.isNotEmpty)
              GestureDetector(
                onTap: () {
                  launch("tel://${deal.mobile}");
                },
                child: CRMIconAndText(
                  AppThemePreferences.phoneFilledIcon,
                  deal.mobile,
                ),
              ),
          ],
