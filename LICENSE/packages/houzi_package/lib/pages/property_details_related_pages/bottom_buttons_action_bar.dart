...
class _PropertyProfileBottomButtonActionBarState extends State<PropertyProfileBottomButtonActionBar> {
  ...
  Widget emailElevatedButtonWidget(){
    return UtilityMethods.widgetItem(context, widget.article, "email_button") ?? ButtonWidget(
  ...
  Widget callElevatedButtonWidget(){
    return UtilityMethods.widgetItem(context, widget.article, "call_button") ?? ButtonWidget(
  ...
  Widget whatsappElevatedButtonWidget() {
    return UtilityMethods.widgetItem(context, widget.article, "whatsapp_button") ?? ButtonWidget(
      text: UtilityMethods.getLocalizedString("whatsapp"),
      fontSize: 12,color: AppThemePreferences.whatsAppBackgroundColor,
  ...
  onWhatsAppButtonPressed() async {
    String msg = UtilityMethods.getLocalizedString("whatsapp_hello_i_am_interested_in",inputWords: [UtilityMethods.stripHtmlIfNeeded(widget.article!.title!),widget.articleLink]);
