        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              _floorPlansList.isNotEmpty
                  ? Column(
                      children: _floorPlansList.map((floorPlanElement) {
                        int itemIndex =
                            _floorPlansList.indexOf(floorPlanElement);
                        return GenericFloorPlanWidget(
                          ...
                          genericFloorPlanWidgetListener: (int index,
                            ...
                            if (removeItem) {
                              if (mounted) {
                                setState(() {
                                  _floorPlansList.removeAt(index);
                                });
                              }
                            } else {
                              if (mounted) {
                                setState(() {
                                  _floorPlansList[index].dataMap = itemDataMap;
                                });
                              }
                            }
