                  ...
                  onChanged: (value){
                    if(value != null){
                      if(mounted) setState(() {
                        ...
                        dataMap[ADD_PROPERTY_PROPERTY_FEATURED] = "$_groupValueForFeaturedOption";
            ...
            child: Row(
              ...
              children: [
                userChoiceFromRadioButton(
                  ...
                  optionText: UtilityMethods.getLocalizedString("no"),//AppLocalizations.of(context).no,
                  // optionText: optionsList[0],
                ),
                userChoiceFromRadioButton(
                  value: 1,
