...
class _PropertiesState extends State<Properties> with TickerProviderStateMixin {
  ...
  Widget propertiesWithOutDrafts(){
    return (userRole == ROLE_ADMINISTRATOR) ? DefaultTabController(
      length: _tabsChildrenList.length,
        ...
        builder: (BuildContext bc) {
          return Wrap(
            children: [
              ...
              if (userRole == ROLE_ADMINISTRATOR && (actionButtonMap["_status"] == STATUS_ON_PENDING || actionButtonMap["_status"] == STATUS_ON_HOLD))
                genericOptionsOfBottomSheet(
                  actionButtonMap["_propertyId"],
              ...
              //   genericOptionsOfBottomSheet(
              //     actionButtonMap["_propertyId"],
              //     GenericMethods.getLocalizedString("upgrade_featured"),
              //     propertyListIndex: actionButtonMap["index"],
              //     article: actionButtonMap["item"],
              //     onPressed: upgradeToFeatured,
              //   )
              // else if (actionButtonMap["_author"] == userId
              //     && userPaymentStatusMap[enablePaidSubmissionKey] == perListing)
              //   genericOptionsOfBottomSheet(
              //     actionButtonMap["_propertyId"],
              //     GenericMethods.getLocalizedString("pay_now"),
              //     propertyListIndex: actionButtonMap["index"],
              //     article: actionButtonMap["item"],
              //     onPressed: upgradeToFeatured,
              //   )
              ...
              //   genericOptionsOfBottomSheet(
              //     actionButtonMap["_propertyId"],
              //     GenericMethods.getLocalizedString("set_featured"),
              //     propertyListIndex: actionButtonMap["index"],
              //     article: actionButtonMap["item"],
              //     onPressed: upgradeToFeatured,
              //   ),
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: TextButton(
          ...
          onPressed: () async {
            if(label == UtilityMethods.getLocalizedString("put_on_hold") || label == UtilityMethods.getLocalizedString("publish_property")){
              onPressedForStatus!(propertyId,propertyListIndex,article,changeStatusValue);
            } else {
  ...
  Future<void> editProperty(int? propertyId,int? propertyListIndex) async {
    Future<Map<String, dynamic>> futureDataMapForUpdateProperty = UtilityMethods.convertArticleToMap(propertyId!,userId!,_propertyBloc);
    futureDataMapForUpdateProperty.then((value) {
      Map<String, dynamic> dataMapForUpdateProperty = value;
