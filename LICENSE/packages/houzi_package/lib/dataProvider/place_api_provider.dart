...
class PlaceApiProvider {
  ...
  static Future<Response> getPlaceDetailFromCordinates(String cordinates) async {
    final request = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=$cordinates&key=$GOOGLE_MAP_API_KEY';
