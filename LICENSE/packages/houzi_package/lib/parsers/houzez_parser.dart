...
class HouzezParser implements ApiParserInterface {
  ...
  static AgentMetaData parseAgentMetaDataMap(Map<String, dynamic> json) {
    ...
    termId = UtilityMethods.getIntegerItemValueFromMap(inputMap: json, key: "term_id");
    termGroup = UtilityMethods.getIntegerItemValueFromMap(inputMap: json, key: "term_group");
    termTaxonomyId = UtilityMethods.getIntegerItemValueFromMap(inputMap: json, key: "term_taxonomy_id");
    parent = UtilityMethods.getIntegerItemValueFromMap(inputMap: json, key: "parent");
    count = UtilityMethods.getIntegerItemValueFromMap(inputMap: json, key: "count");

    name = UtilityMethods.getStringItemValueFromMap(inputMap: json, key: "name") ?? "";
